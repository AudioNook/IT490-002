...
class Deployer
{
    ...
    public function retrieve_source_zip()
    {
        ...
        //TODO - make a function to create the zip file name using the current date and DB version
        $zip_file = 'myapp.zip';

        $source_connection = $this->connect_ssh($host, $user, $pass);
        $this->create_zip($source_connection, $target_dir, $zip_file);
