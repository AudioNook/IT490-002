          ...
          <?php if (count($cart) > 0) : ?>
            <?php foreach ($cart as $c) : ?>
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                  <h6 class="my-0"><?php echo htmlspecialchars($c["name"]); ?></h6>
                  <small class="text-muted">This is a Product!</small>
                </div>
                <span class="text-muted"> $<?php echo htmlspecialchars($c["unit_price"]); ?></span>
              </li>
        ...
        <form class="needs-validation" novalidate>
            ...
            <div class="col-md-4 mb-3">
              ...
              <select>
                ...
                foreach ($states as $abbreviation => $state) {
                  $selected = $abbreviation === '' ? 'selected="selected"' : '';
                  echo "<option value=\"{$abbreviation}\" {$selected}>{$state}</option>";
                }
                ?>
              </select>
              <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="ccexpiration" placeholder="" required>
              <div class="invalid-feedback">
